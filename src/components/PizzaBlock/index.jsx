    ...
    <div className="pizza-block-wrapper">
      <div className="pizza-block">
        ...
        <div className="pizza-block__selector">
          <ul>
            { types.map((typeId, idx) => <li key={ idx }
                                             className={ activeType === idx ? 'active' : '' }
                                             onClick={ () => setActiveType(idx) }
            >{ typeNames[typeId] }</li>) }
          </ul>
          <ul>
            { sizes.map((item, idx) => <li key={ idx }
        ...
        <div className="pizza-block__bottom">
          ...
          <button className="button button--outline button--add" onClick={ onOnClickAddButton }>
            <svg
              width="12"
              height="12"
              viewBox="0 0 12 12"
